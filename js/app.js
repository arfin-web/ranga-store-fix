...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product shadow-lg rounded-3">
      <div>
    <img class="product-image mt-2" src=${image}></img>
      ...
      <h4 class="fw-bold">Rating: <span class="text-warning">${product.rating.rate}</span></h4>
      ...
      <button  onclick="showDetails(${product.id})" id="details-btn" class="btn btn-danger fw-bold">Details</button></div>
      `;
...
const displayDetails = (product) => {
  ...
  <div class="card w-50 mx-auto mb-5 shadow-lg rounded-3 border-0 p-2">
